...
static magici magic_misc2[] = {
	...
	{26, Drums, Scarying},
	{27, Drums, Thundering},
	{33, Dust, DetectInvisibility},
	{39, Dust, Invisibility},
	{40, Dust, Choking},
	{41, Bottle, SummonDjin},
...
static magici magic_rod_staff_wands[] = {
	...
	{61, Wand, Illusion},
	{64, Wand, Lighting},
	{69, Wand, DetectSpells},
	{74, Wand, MagicMissiles},
	{79, Wand, DetectTreasure},
	{84, Wand, Dispelling},
	{87, Wand, Paralysation},
	{90, Wand, Transformation},
	{94, Wand, Radiance},
	{97, Wand, DetectSecretDoors},
	{98, Wand, SummonDjin},
	{100, Wand, DetectTrap},
};
...
static void add_item(item& it) {
	if(!it)
		return;
	it.drop(variant(last_settlement), Market, 0);
}
