...
enum ioseekf { SeekSet, SeekCur, SeekEnd };
enum iostreamf {
	StreamRead = 1,
	StreamWrite = 2,
	StreamText = 4,
...
char* szurl(char* result, const char* base, const char* folder, const char* name, const char* ext = 0, const char* suffix = 0);